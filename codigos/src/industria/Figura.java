...
/**
 * A classe
 * <code>Figura</code> � a classe base para implementar as demais formas
 * geometricas
 *
 * <p><blockquote><pre>
...
public abstract class Figura {
    ...
    public boolean testaLocal(Ponto pt) {
        //System.out.println(pt.getX() +"<="+ this.getX() +"||"+ pt.getX() +">="+ this.getX() +"+"+ this.getLargura() +"&&"+ pt.getY() +"<"+ this.getY() +"||"+ pt.getY() +">"+ this.getY() +"+"+ this.getLargura());
        if ((pt.getX() <= this.getX() || pt.getX() >= this.getX() + this.getLargura()) || (pt.getY() < this.getY() || pt.getY() > this.getY() + this.getLargura())) 
        {   
